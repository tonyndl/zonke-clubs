    ...
    function kb() {
      return xa || (!na && !pa) || "function" !== typeof fetch || fb("file://")
        ...
        : fetch(gb, { credentials: "same-origin" })
            .then(function (a) {
              if (!a.ok)
                throw "failed to load wasm binary file at '" + gb + "'";
        ...
        createNode: function (a, b, c, d) {
          ...
          L.re ||
            (L.re = {
              ...
              link: {
                node: { oe: L.Vd.oe, ee: L.Vd.ee, readlink: L.Vd.readlink },
                stream: {},
              },
          ...
          K.be(c.mode)
            ...
            : K.isFile(c.mode)
              ...
              : K.xe(c.mode)
                ...
                : K.Oe(c.mode) &&
                  ((c.Vd = L.re.Kf.node), (c.Wd = L.re.Kf.stream));
        ...
        Pg: function (a, b) {
          if (a.Zd != b)
            if (0 == b) ((a.Ud = null), (a.Zd = 0));
              ...
              } else if ((a.Ud || (a.Ud = []), a.Ud.length > b))
                a.Ud.length = b;
    ...
    var qd = {
      ...
      Ka: function (a, b, c, d) {
        try {
          ...
          return (
            ("undefined" !== typeof K && oa instanceof K.Td) || n(oa),
            -oa.Xd
          );
        }
      },
      Ba: function (a, b) {
        try {
          ...
          return (
            ("undefined" !== typeof K && f instanceof K.Td) || n(f),
            -f.Xd
          );
        }
      },
      o: function (a, b, c) {
        ...
        try {
          ...
          return (
            ("undefined" !== typeof K && g instanceof K.Td) || n(g),
            -g.Xd
          );
        }
      },
      Ma: function (a, b) {
        try {
          ...
          return (
            ("undefined" !== typeof K && d instanceof K.Td) || n(d),
            -d.Xd
          );
        }
      },
      Ia: function (a, b, c) {
        try {
          ...
          return (
            ("undefined" !== typeof K && t instanceof K.Td) || n(t),
            -t.Xd
          );
        }
      },
      Ea: function (a, b) {
        try {
          ...
          return (
            ("undefined" !== typeof K && c instanceof K.Td) || n(c),
            -c.Xd
          );
        }
      },
      ...
      va: function (a, b, c, d, f, g) {
        try {
          ...
          return (
            ("undefined" !== typeof K && v instanceof K.Td) || n(v),
            -v.Xd
          );
        }
      },
      ...
      wa: function (a, b) {
        try {
          ...
          return (
            ("undefined" !== typeof K && r instanceof K.Td) || n(r),
            -r.Xd
          );
        }
      },
      ...
      Da: function (a) {
        try {
          ...
          return (
            ("undefined" !== typeof K && b instanceof K.Td) || n(b),
            -b.Xd
          );
        }
      },
      ...
      ua: function (a, b, c, d) {
        try {
          ...
          return (
            ("undefined" !== typeof K && q instanceof K.Td) || n(q),
            q.Xd
          );
        }
      },
      Ta: function (a, b, c, d, f) {
        try {
          ...
          return (
            ("undefined" !== typeof K && h instanceof K.Td) || n(h),
            h.Xd
          );
        }
      },
    ...
    (function () {
      ...
      if (e.instantiateWasm)
        try {
          ...
          return (
            k("Module.instantiateWasm callback failed with error: " + f),
            !1
          );
        }
      (function () {
