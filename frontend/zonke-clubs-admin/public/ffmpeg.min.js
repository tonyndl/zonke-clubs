    ...
    var e = {
        ...
        839: (e, t, r) => {
          ...
          const o = {
            corePath: "https://unpkg.com/@ffmpeg/core@".concat(
              n.devDependencies["@ffmpeg/core"].substring(1),
              "/dist/ffmpeg-core.js",
            ),
          };
          var a = r(185),
                      ...
                      switch ((e.prev = e.next)) {
                        ...
                        case 4:
                          return (
                            (c = new URL(
                              r,
                              "file:///home/jeromewu/repos/ffmpeg.wasm/src/browser/getCreateFFmpegCore.js",
                            ).href),
                            (e.next = 7),
                          ...
                          return e.abrupt(
                            ...
                            new Promise(function (e) {
                              if (
                                ...
                                throw Error(
                                  (0, i.CREATE_FFMPEG_CORE_IS_NOT_DEFINED)(c),
                                );
                              ((0, a.log)(
                                "info",
                                "ffmpeg-core.js script loaded",
                              ),
                                e({
                                  createFFmpegCore,
                                  corePath: s,
                              ...
                              ((t.src = m),
                                ...
                                t.addEventListener("load", function r() {
                                  if (
                                    ...
                                    throw Error(
                                      (0, i.CREATE_FFMPEG_CORE_IS_NOT_DEFINED)(
                                        p,
                                      ),
                                    );
                                  ((0, a.log)(
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 3:
                            ...
                            if (
                              !/data:_data\/([a-zA-Z]*);base64,([^"]*)/.test(t)
                            ) {
                              e.next = 8;
                              break;
                            }
                          ...
                          case 8:
                            return (
                              ...
                              fetch(
                                new URL(
                                  t,
                                  "file:///home/jeromewu/repos/ffmpeg.wasm/src/browser/fetchFile.js",
                                ).href,
                              )
                            );
                          case 10:
        ...
        906: (e, t, r) => {
          ...
          e.exports = function () {
            var e =
              ...
              C = function (e) {
                var t = i(e.split(":"), 3),
                  ...
                  o = t[2];
                return (
                  60 * parseFloat(r) * 60 + 60 * parseFloat(n) + parseFloat(o)
                );
              },
              A = function (e, t) {
                if ("string" == typeof e)
                  if (e.startsWith("  Duration")) {
                    ...
                    t({ ratio: L, time: c });
                  } else e.startsWith("video:") && (t({ ratio: 1 }), (P = 0));
              },
              T = function (e) {
                var t = e.type,
                  r = e.message;
                          ...
                          case 5:
                            return (
                              ...
                              r({
                                ...
                                printErr: function (e) {
                                  return T({ type: "fferr", message: e });
                                },
                                print: function (e) {
                                  return T({ type: "ffout", message: e });
                                },
              ...
              I = function () {
                for (
                  ...
                  t[r] = arguments[r];
                if (
                  (_("info", "run ffmpeg command: ".concat(t.join(" "))),
                  null === s)
                )
                  throw x;
                if (y)
            ...
            return (
              _("info", "use ffmpeg.wasm v".concat(b)),
              {
                setProgress: D,
                setLogger: W,
                setLogging: B,
        ...
        835: (e) => {
          e.exports = {
            CREATE_FFMPEG_CORE_IS_NOT_DEFINED: function (e) {
              return "\ncreateFFmpegCore is not defined. ffmpeg.wasm is unable to find createFFmpegCore after loading ffmpeg-core.js from ".concat(
                e,
                ". Use another URL when calling createFFmpeg():\n\nconst ffmpeg = createFFmpeg({\n  corePath: 'http://localhost:3000/ffmpeg-core.js',\n});\n",
              );
            },
          };
        },
